...
public class BannerProperties
{
	...
	public static BannerProperties load(String filename)
	{
		try {
			...
			return load(propertiesInputStream);
		} catch (FileNotFoundException e) {
			throw new RuntimeException("Banner Properties Problem");
	...
	public static BannerProperties load(FileInputStream fio)
	{
		...
		try
		{
			...
			properties.load(fio);
			fio.close();
			String lemmatiserDataDirectory = getPath(properties.getProperty("lemmatiserDataDirectory"));
			if (lemmatiserDataDirectory != null)
				bannerProperties.lemmatiser = new EngLemmatiser(lemmatiserDataDirectory, false, true);
			String posTaggerDataDirectory = getPath(properties.getProperty("posTaggerDataDirectory"));
			...
			String dictionaryFileName = getPath(properties.getProperty("dictionary"));
